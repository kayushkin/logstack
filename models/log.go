...
type TurnStats struct {
	...
	DurationAPIMs       int64       `json:"duration_api_ms,omitempty"` // time spent in API calls only
	...
	APICallUsages       []APICallUsage   `json:"api_call_usages,omitempty"`
}

// APICallUsage records token usage for a single API round-trip.
